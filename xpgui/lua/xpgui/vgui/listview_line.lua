...
function PANEL:Think()
	if self:GetParent():IsLineSelected() or self:GetParent():IsHovered() then
		...
		self:SetTextColor(Color(160,160,160))
	end
end
...
derma.DefineControl("XPListViewLine", "A line from the List View", PANEL, "Panel")
derma.DefineControl("XPListView_Line", "A line from the List View", PANEL, "Panel")